        ...
        <div class="panel-heading">
          <strong>
            ...
            <span>Requisition No: 
                ...
                <?php  if($grn['req_id']==null){ echo "without requisition";}else{ ?>
            ...
            <tbody>
              <?php foreach ($all_grn_details as $grndetails):?>
                <tr>
                  ...
                  <td><?php if($grndetails['unit_type']=='number') echo intval($grndetails['quantity']); else echo  $grndetails['quantity']; ?></td>
