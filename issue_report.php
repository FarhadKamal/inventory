  ...
  <div class="col-md-6">
    <div class="panel">
      ...
      <div class="panel-body">
        <form class="clearfix" method="post" target="_blank" action="issue_report_process.php">
          ...
          <div class="form-group"> <label>Location</label>
            <div class="input-group">
             ...
             <select class="form-control"  name="location" style="width: 500px;">
        ...
        <div class="form-group"> <label>Cost Centre</label>
            <div class="input-group">
              ...
              <select class="form-control"  name="cost-centre-name"  id="cost_id" style="width: 500px;">
              <option value="0">ALL</option>
