...
if(isset($_POST['submit'])){
  ...
  if(empty($errors)){
    ...
    $results      = product_tracking_by_dates($start_date,$end_date,$location,$product  );
    $res          = track_product_stock($start_date,$end_date,$location,$product  );
       ...
       table thead tr th {
         ...
         border: 1px solid #ededed;
           ...
           <body>
            ...
            onclick="tableToExcel('excel', 'Product Tracking Report', 'ProductTrackingReport.xls')" 
